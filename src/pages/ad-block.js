...
const AdBlock = () => (
  <Wrapper>
    ...
    <TextWrapper>
      ...
      <Content>
        <Description>
          Mas calma! Você não precisa remover o seu AdBlock, apenas permitir que
          ele não bloqueie a sua doação.
        </Description>
        <AdBlockWrapper>
          <AdBlockName>AdBlock Plus</AdBlockName>
          <AdBlockDescription>
            1) Clique no ícone do AdBlock Plus, localizado à direita da barra de
        ...
        <AdBlockWrapper>
          ...
          <AdBlockDescription>
            3) Clique em “Don’t run on pages on this domain” para desativar o
            bloqueio da publicidade
          </AdBlockDescription>
          <AdBlockDescription>
            4) Uma nova janela abrirá e você precisará clicar no botão “Exclude”
          </AdBlockDescription>
          <AdBlockDescription>5) Atualize esta página</AdBlockDescription>
        ...
        <AdBlockWrapper>
          ...
          <AdBlockDescription>
            1) Clique no ícone do AdBlock Pro, localizado à direita da barra de
            endereços do seu navegador
          </AdBlockDescription>
          <AdBlockDescription>
            2) Um menu drop-down aparecerá na tela
          ...
          <AdBlockDescription>
            3) Clique no primeiro ícone (ligar) para para desativar o bloqueio
            da publicidade
          </AdBlockDescription>
